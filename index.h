...
<button style=background-color:#99cc00; size= 40% >a6set</button>
<button style="background-color:#ff5050; size= 100%">clear6</button>
...
<button style=background-color:#99cc00; size= 40% >a7set</button>
<button style="background-color:#ff5050; size= 100%">clear7</button>
...
<button style=background-color:#99cc00; size= 40% >a8set</button>
<button style="background-color:#ff5050; size= 100%">clear8</button>
...
<h style="color:#3333ff;">Set Time :----------</h>
<form>
<input type="text" name="HH_ALARM6" size= 2% placeholder="HH">
<input type="text" name="MM_ALARM6" size= 2% placeholder="MM">
<input type="text" name="SS_ALARM6" size= 2% placeholder="SS">
...
<h style="color:#3333ff;">Set Time :----------</h>
<form>
<input type="text" name="HH_ALARM7" size= 2% placeholder="HH">
<input type="text" name="MM_ALARM7" size= 2% placeholder="MM">
<input type="text" name="SS_ALARM7" size= 2% placeholder="SS">
...
<h style="color:#3333ff;">Set Time :----------</h>
<form>
<input type="text" name="HH_ALARM8" size= 2% placeholder="HH">
<input type="text" name="MM_ALARM8" size= 2% placeholder="MM">
<input type="text" name="SS_ALARM8" size= 2% placeholder="SS">
...
const char STATUS_PAGE[] PROGMEM = R"=====(
    ...
    <br>
    <h2 style=" text-decoration: underline;color:blue;text-align:center">Your Fourth alarm is: @@SET4@@ </h2>
    <br>
    <h2 style=" text-decoration: underline;color:blue;text-align:center">Your Fifth alarm is: @@SET5@@ </h2>
    </br>
    <h2 style=" text-decoration: underline;color:blue;text-align:center">Your Sixth alarm is: @@SET6@@ </h2>
    <br>
    <h2 style=" text-decoration: underline;color:blue;text-align:center">Your Seventh alarm is: @@SET7@@ </h2>
    <br>
    <h2 style=" text-decoration: underline;color:blue;text-align:center">Your Eighth alarm is: @@SET8@@ </h2>
    <br>
